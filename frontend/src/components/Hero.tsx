      ...
      <div className="relative z-10 text-center max-w-4xl mx-auto">
        ...
        <div className="mb-8 flex justify-center">
          <div className="relative">
            <div className="w-24 h-24 bg-neon-gradient rounded-lg transform rotate-45 flex items-center justify-center neon-glow">
        ...
        {/* Brand name */}
        <h1 className="text-5xl md:text-7xl font-bold mb-4 text-neon">
        ...
        <button
          onClick={onStartGame}
          className="px-8 py-4 bg-neon-gradient rounded-xl font-bold text-lg text-white neon-glow neon-glow-hover transform transition-all duration-300 hover:scale-105"
        >
          НАЧАТЬ ИГРУ
        </button>
      </div>
